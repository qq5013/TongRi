...
namespace Sorting.Optimize
{
    ...
    {
        public DataTable Optimize(DataTable routeTable, DataTable lineTable, string orderDate, string batchNo)
        {
            ...
            if (lineTable.Rows.Count > 1)
            {
                ...
                foreach (DataRow routeRow in routeTable.Rows)
                {
                    ...
                    DataRow [] lineRows = lineTable.Select(string.Format("LINECODE = '{0}'", routeRow["LINECODE"]), "TOTALQUANTITY");
                    ...
                    {
                        lineRow = lineTable.Select("", "TOTALQUANTITY")[0];
                    }
        ...
        private void AddRow(DataTable lineTable, DataRow routeRow, object lineCode, string orderDate, string batchNo)
        {
