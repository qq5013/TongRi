<%@ page language="C#" autoeventwireup="true" inherits="WebUI_Stock_InventoryTasks, WMS_deploy" theme="Default" stylesheettheme="Default" %>
                ...
                <div>
                    ...
                    <tr>
						    ...
						    <td  width="15%" height="20">&nbsp;<asp:dropdownlist id="ddlField" runat="server" Width="85%" >
                                    ...
                                    <asp:ListItem Value="BillTypeName">盘库类型</asp:ListItem>
                                    <asp:ListItem Value="BillID">盘库单号</asp:ListItem>
                          ...
                          <td align="right"  style="width:30%" valign="middle">
                            ...
                            <asp:Button ID="btnAdd" runat="server" Text="盘库作业" CssClass="ButtonCreate" 
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" SkinID="GridViewSkin" Width="100%" OnRowDataBound="GridView1_RowDataBound">
                        <Columns>
                            <asp:TemplateField >
                             ...
                             <asp:BoundField DataField="BillID" HeaderText="盘库单号" SortExpression="BillID">
                                <ItemStyle HorizontalAlign="Left" Width="10%" Wrap="False" />
                                <HeaderStyle Wrap="False" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="盘库日期" SortExpression="BillDate">
                                <ItemTemplate>
                           ...
                           <asp:BoundField DataField="BillTypeName" HeaderText="盘库类型" SortExpression="BillTypeName">
                                <ItemStyle HorizontalAlign="Left" Width="10%" Wrap="False" />
                                <HeaderStyle Wrap="False" />
                            </asp:BoundField>
