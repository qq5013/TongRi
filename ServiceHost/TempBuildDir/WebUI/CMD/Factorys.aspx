<%@ page language="C#" autoeventwireup="true" inherits="WebUI_CMD_Factorys, WMS_deploy" theme="Default" stylesheettheme="Default" %>
                ...
                <div id="table-container" style="overflow: auto; WIDTH: 100%; HEIGHT: 470px">
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="厂家编码"  SortExpression="FactoryID">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# FormID+"View.aspx?SubModuleCode=" + SubModuleCode+"&FormID=" + FormID +"&SqlCmd="+SqlCmd+ "&ID="+DataBinder.Eval(Container.DataItem, "FactoryID") %>'
                                        Text='<%# DataBinder.Eval(Container.DataItem, "FactoryID")%>'></asp:HyperLink>
                                </ItemTemplate>
                              <ItemStyle Width="10%" Wrap="False" HorizontalAlign="Left"/>
                              <HeaderStyle Width="10%" Wrap="False" />
                           </asp:TemplateField>
                           
                            <asp:BoundField DataField="FactoryName" HeaderText="厂家名称" 
