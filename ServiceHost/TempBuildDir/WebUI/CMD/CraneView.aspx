<%@ page language="C#" autoeventwireup="true" inherits="WebUI_CMD_CraneView, WMS_deploy" theme="Default" stylesheettheme="Default" %>
            ...
            <ContentTemplate>
                 ...
                 <table id="Table1" class="maintable"  width="100%" align="center" cellspacing="0" cellpadding="0" bordercolor="#ffffff" border="1" 
				     ...
				     <tr>
                        ...
                        <td  width="25%">
                                &nbsp;<asp:TextBox ID="txtID" runat="server"   CssClass="TextRead" Width="90%" MaxLength="10" 
                        ...
                        <td width="25%">
                                &nbsp;<asp:TextBox ID="txtTypeName" runat="server"  
                                    CssClass="TextRead" Width="90%" MaxLength="30" ReadOnly="True"></asp:TextBox> 
                        </td>
