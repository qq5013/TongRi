<%@ page language="C#" autoeventwireup="true" inherits="WebUI_CMD_ProductStates, WMS_deploy" theme="Default" stylesheettheme="Default" %>
                    ...
                    <tr>
						    ...
						    <td  width="15%" height="20">&nbsp;
                                <asp:dropdownlist id="ddlField" runat="server" Width="85%" >
                                    <asp:ListItem  Selected="True" Value="StateName">状态名称</asp:ListItem>
                ...
                <div id="table-container" style="overflow: auto; WIDTH: 100%; HEIGHT: 470px">
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="状态编码"  SortExpression="StateNo">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# FormID+"View.aspx?SubModuleCode=" + SubModuleCode+"&FormID=" + FormID +"&SqlCmd="+SqlCmd+ "&ID="+DataBinder.Eval(Container.DataItem, "StateNo") %>'
                                        Text='<%# DataBinder.Eval(Container.DataItem, "StateNo")%>'></asp:HyperLink>
                                </ItemTemplate>
                              <ItemStyle Width="10%" Wrap="False" HorizontalAlign="Left"/>
                              <HeaderStyle Width="10%" Wrap="False" />
                           </asp:TemplateField>
                           <asp:BoundField DataField="StateName" HeaderText="状态名称" 
